          ...
          <div>
            ...
            <Reveal>
              <p className="text-[15px] text-muted-foreground leading-[1.75] mb-3.5">
                Я психолог, EMDR терапевт. Не говорю общими фразами и не обещаю чудес. Я предлагаю пространство, где можно просто быть собой.
              </p>
            </Reveal>
            <Reveal>
              <p className="text-[15px] text-muted-foreground leading-[1.75] mb-3.5">
            ...
            <Reveal>
              <p className="text-[15px] text-muted-foreground leading-[1.75] mb-3.5">
                Среди моих клиентов — люди в кризисе и те, кто просто чувствует: что-то не так, хотя снаружи всё нормально.
              </p>
            </Reveal>
            <Reveal>
